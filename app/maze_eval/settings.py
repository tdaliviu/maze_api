"""
Django settings for maze_eval project.
...
ALLOWED_HOSTS = ['192.168.99.100', 'localhost', '.compute.amazonaws.com']
...
WSGI_APPLICATION = 'maze_eval.wsgi.application'
